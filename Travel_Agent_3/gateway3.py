...
class GatewayService3:
    ...
    @http('GET', '/travel-agent-3/package/<int:id>')
    ...
    @http('GET', '/travel-agent-3/bookings')
    ...
    @http('GET', '/travel-agent-3/filter')
