...
class GatewayService:
    ...
    @http('GET', '/travel-agent-1/package/<int:id>')
    ...
    @http('GET', '/travel-agent-1/bookings')
    def get_my_booking(self,request):
        my_booking = self.travel_agent_rpc.get_my_booking()
        return (200, self.header, json.dumps(my_booking))
    
    @http('POST', '/travel-agent-1/book')
    ...
    @http('GET', '/travel-agent-1/filter')
